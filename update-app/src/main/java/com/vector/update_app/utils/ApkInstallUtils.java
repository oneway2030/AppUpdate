...
public final class ApkInstallUtils {
     ...
     * apk安装的请求码
     */
    public static final int REQUEST_CODE_INSTALL_APP = 99;
    ...
    public static Intent getInstallAppIntent(Context context, File appFile) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                uri = FileProvider.getUriForFile(context, context.getApplicationContext().getPackageName() + ".fileProvider", appFile);
